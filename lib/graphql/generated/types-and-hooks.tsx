...
export function useGetAllGamesSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<GetAllGamesQuery, GetAllGamesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
 ...
 * });
 */
export function useGetAllReviewsByUserQuery(baseOptions: Apollo.QueryHookOptions<GetAllReviewsByUserQuery, GetAllReviewsByUserQueryVariables> & ({ variables: GetAllReviewsByUserQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetAllReviewsByUserQuery, GetAllReviewsByUserQueryVariables>(GetAllReviewsByUserDocument, options);
      }
export function useGetAllReviewsByUserLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetAllReviewsByUserQuery, GetAllReviewsByUserQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetAllReviewsByUserQuery, GetAllReviewsByUserQueryVariables>(GetAllReviewsByUserDocument, options);
        }
export function useGetAllReviewsByUserSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<GetAllReviewsByUserQuery, GetAllReviewsByUserQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetAllReviewsByUserQuery, GetAllReviewsByUserQueryVariables>(GetAllReviewsByUserDocument, options);
        }
export type GetAllReviewsByUserQueryHookResult = ReturnType<typeof useGetAllReviewsByUserQuery>;
export type GetAllReviewsByUserLazyQueryHookResult = ReturnType<typeof useGetAllReviewsByUserLazyQuery>;
export type GetAllReviewsByUserSuspenseQueryHookResult = ReturnType<typeof useGetAllReviewsByUserSuspenseQuery>;
export type GetAllReviewsByUserQueryResult = Apollo.QueryResult<GetAllReviewsByUserQuery, GetAllReviewsByUserQueryVariables>;
 ...
 * });
 */
export function useGetAllReviewsForGameQuery(baseOptions: Apollo.QueryHookOptions<GetAllReviewsForGameQuery, GetAllReviewsForGameQueryVariables> & ({ variables: GetAllReviewsForGameQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetAllReviewsForGameQuery, GetAllReviewsForGameQueryVariables>(GetAllReviewsForGameDocument, options);
      }
export function useGetAllReviewsForGameLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetAllReviewsForGameQuery, GetAllReviewsForGameQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetAllReviewsForGameQuery, GetAllReviewsForGameQueryVariables>(GetAllReviewsForGameDocument, options);
        }
export function useGetAllReviewsForGameSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<GetAllReviewsForGameQuery, GetAllReviewsForGameQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetAllReviewsForGameQuery, GetAllReviewsForGameQueryVariables>(GetAllReviewsForGameDocument, options);
        }
export type GetAllReviewsForGameQueryHookResult = ReturnType<typeof useGetAllReviewsForGameQuery>;
export type GetAllReviewsForGameLazyQueryHookResult = ReturnType<typeof useGetAllReviewsForGameLazyQuery>;
export type GetAllReviewsForGameSuspenseQueryHookResult = ReturnType<typeof useGetAllReviewsForGameSuspenseQuery>;
export type GetAllReviewsForGameQueryResult = Apollo.QueryResult<GetAllReviewsForGameQuery, GetAllReviewsForGameQueryVariables>;
 ...
 * });
 */
export function useGetUserRoleQuery(baseOptions: Apollo.QueryHookOptions<GetUserRoleQuery, GetUserRoleQueryVariables> & ({ variables: GetUserRoleQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
...
export function useGetUserRoleSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<GetUserRoleQuery, GetUserRoleQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
